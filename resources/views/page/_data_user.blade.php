            ...
            <div class="x_panel">
                ...
                ?>
                            ...
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-xs {{ $p->level }}" data-toggle="modal"
                                        data-target=".bs-example-modal-lg{{ $p->nik }}"><i class="fa fa-edit"></i>
                                        {{ $p->status }}</button>
                                    <a href="/delete/user/{{ $p->nik }}" class="btn btn-info btn-xs btn-danger"> <i
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal form-label-left" action="{{ route('post.update.akun') }}" method="POST"
                    enctype="multipart/form-data">

                    @else

                    <form class="form-horizontal form-label-left" action="{{ route('post.update.user') }}" method="POST"
                        enctype="multipart/form-data">
                        ...
                        <div class="profile_img">
                            ...
                            <div id="crop-avatar">
                                ...
                                <img class="img-responsive avatar-view" src="{{ url('image/Scan_ktp/'.$p->scan_ktp) }}"
                                    width="75%">
                        ...
                        <div class="profile_img">
                            ...
                            <div id="crop-avatar">
                                ...
                                <img class="img-responsive avatar-view" src="{{ url('image/Photo/'.$p->photo) }}"
                                    width="75%">
