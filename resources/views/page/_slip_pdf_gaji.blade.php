        ...
        <div id="invoice_head">
            <table style="width:350%; border-spacing:0;">
                <tr>
                    ...
                    <td style="font-size: 12pt; width:320%;">
                        <center>
                            <p>KEMENTERIAN HUKUM DAN HAM REPUBLIK INDONESIA
                            <p>KANTOR WILAYAH JAWA BARAT</br>
                            <p><b>LEMBAGA PEMASYARAKATAN KELAS IIA KARAWANG</b></br>
                        </center>
                    </td>
                </tr>
                <tr>
                    <td style="font-size: 7pt;width:320%;">
                        <center>
                            <p>JJl. Surotokunto No.km 6, Kondangjaya, Kec. Karawang Tim., Karawang, Jawa Barat 41371</p>
            ...
            <table style="width:380%; border-spacing:0;" border="0">
                <tr>
                    <td style="font-size: 10pt;"> *Catatan : Data slip gaji dan tunjangan kinerja ini diinput oleh
                        Bendahara Lapas Kelas IIA Karawang</td>
                </tr>
                <tr>
                    <td>
                        </br>
                        <img src="data:image/png;base64,{{DNS2D::getBarcodePNG('silaci.kemenkumham.go.id/cek_slip/'.$p->kode, 'qrcode')}}"
                            }} height="100">
                    </td>
                </tr>
            </table>
