    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        <form action="{{ route('post.about') }}" method="POST" class="form-horizontal form-label-left">
          ...
          <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">No Whatsapp<span class="required">*</span></label>
            <div class="col-md-6 col-sm-6 ">
              <input type="number" id="first-name" name="wa_toko" required="required" class="form-control " value="{{ $apk->wa_toko }}">
            </div>
          </div>
          <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Jumlah WBP<span class="required">*</span></label>
            <div class="col-md-6 col-sm-6 ">
              <input type="number" id="first-name" name="jumlah_wbp" required="required" class="form-control " value="{{ $apk->jumlah_wbp }}">
            </div>
          </div>
          <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Pagu <span class="required">*</span></label>
            <div class="col-md-6 col-sm-6 ">
              <input type="number" id="first-name" name="jumlah_pagu" required="required" class="form-control " value="{{ $apk->jumlah_pagu }}">
            </div>
          </div>
          <div class="item form-group">
