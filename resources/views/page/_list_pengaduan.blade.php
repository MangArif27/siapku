                  ...
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">===== Pengaduan Online =====
                        </h4>
                      ...
                      <div class="modal-body">
                        ...
                        <form class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                          ...
                          <label class="control-label col-md-3 col-sm-3 col-xs-12">Bukti
                            Pertama</label>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><button type="button" class="btn btn-xs btn-success" data-toggle="modal" data-target=".bs-example-modal-lg{{ $p->kode_pengaduan }}"><i class="fa fa-eye"></i> {{ $p->status_pengaduan }}</button>
                  ...
                  <a href="/delete/pengaduan/{{ $p->kode_pengaduan }}" class="btn btn-info btn-xs btn-danger"> <i class="fa fa-trash"></i> Hapus</a>
                </td>
                      ...
                      <div class="modal-body">
                        ...
                        <form class="form-horizontal form-label-left" id="updatepengaduan" action="{{ route('post.updatepengaduan') }}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            <textarea id="alasan" maxlength="50" name="alasan" class="form-control col-md-9 col-sm-9 col-xs-12" placeholder="">{{ $p->alasan }}</textarea>
                          ...
                          <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            <select name="status_pengaduan" id="status_pengaduan" class="form-control">
                              ...
                              <option value="TIDAK DITINDAK LANJUTI">TIDAK DITINDAK
                                LANJUTI</option>

                              <option value="TINDAK LANJUTI" selected>TINDAK LANJUTI
                              </option>
                              ...
                              <option value="TIDAK DITINDAK LANJUTI" selected>TIDAK
                          ...
                          <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            <select name="status_bukti" id="status_pengaduan" class="form-control">
                              ...
                              <option value="TIDAK TERBUKTI" selected>TIDAK TERBUKTI
                              </option>
                          ...
                          <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            <textarea maxlength="50" id="alasan_pembuktian" name="alasan_pembuktian" class="form-control col-md-9 col-sm-9 col-xs-12" placeholder="">{{ $p->alasan_pembuktian }}</textarea>
