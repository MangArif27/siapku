    ...
    <div class="kunjunganCetak">
        ...
        <div style="width:auto">
            ...
            <table class="header">
                <tr>
                    <td rowspan="4">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/ee/Logo_of_the_Ministry_of_Law_and_Human_Rights_of_the_Republic_of_Indonesia.svg/1876px-Logo_of_the_Ministry_of_Law_and_Human_Rights_of_the_Republic_of_Indonesia.svg.png"
                            width='70px'>
                    </td>
                    <td align="center">
            ...
            <table id="biodataPengunjung">
                ...
                <tr>
                    ...
                    <td rowspan="5">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img
                            src="{{ url('image/Photo/'.$users->photo) }}" style="width:50px" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3">
                        <table class="barang" cellpadding="0" cellspacing="0">
                            ...
                            @endif
                            <?php $tanggal=date('Y-m-d'); $no=1;  ;?>
                            @foreach($pengikut =
                            DB::table('pengikut')->where('nik',$kunjungan->nik)->where('tanggal_kunjungan',$kunjungan->tanggal_kunjungan)->get()
                            as $pengikuts)
                            <tr>
                                <td>{{ $no++ }}</td>
            ...
            <table>
                <tr>
                    ...
                    <td width="337" align="center"><span class="style1"><img
                                src="data:image/png;base64,{{DNS2D::getBarcodePNG($kunjungan->kode_booking, 'qrcode')}}"
                                }} height="120">
                    </td>
                </tr>
            </table>
