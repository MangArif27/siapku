        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    @endif
                    <h2>Riwayat Gaji Pegawai Lapas Kelas IIA Karawang</h2>
                    <ul class="nav navbar-right panel_toolbox">
                        <li><button type="button" class="btn btn-success" data-toggle="modal"
                                data-target=".bs-example-modal-lg"><i class="fa fa-plus"></i> Upload Gaji</button></li>
                        <li><button type="button" class="btn btn-success" data-toggle="modal"
                                data-target=".bs-example-modal-lgtambah"><i class="fa fa-plus"></i> Tambah Gaji</button>
                        </li>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal form-label-left"
                                            action="{{ route('upload.gaji') }}" method="POST"
                        ...
                        <div class="modal fade bs-example-modal-lgtambah" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal form-label-left"
                                            action="{{route('post.insert.gaji')}}" method="POST"
                                            enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            ...
                                            <label class="control-label col-md-4 col-sm-4 col-xs-12">Potongan Dharma
                                                Wanita</label>
                                            <div class="col-md-5 col-sm-5 col-xs-12">
                                                <input type="number" id="potongan_bank" name="potongan_dw"
                                                    class="form-control">
                                            </div>
                                            </br>
                                            </br>
                                            <label class="control-label col-md-4 col-sm-4 col-xs-12">Potongan Bank
                                                BRI/BSM</label>
                                            <div class="col-md-5 col-sm-5 col-xs-12">
                                                <input type="number" id="potongan_koperasi" name="potongan_bank"
                                                    class="form-control">
                                            </div>
                                            </br>
                                            </br>
                                            <label class="control-label col-md-4 col-sm-4 col-xs-12">Potongan
                                                Koperasi</label>
                                            <div class="col-md-5 col-sm-5 col-xs-12">
                                                <input type="number" id="potongan_dw" name="potongan_koperasi"
                                                    class="form-control">
                                            </div>
                                            </br>
                                            </br>
                                            ...
                                            <div class="col-md-5 col-sm-5 col-xs-12">
                                                <input type="number" id="arisan_dw" name="dana_sosial"
                                                    class="form-control">
                                            </div>
                                            </br>
                                            </br>
                                            <label class="control-label col-md-4 col-sm-4 col-xs-12">Sumbangan
                                                Olahraga</label>
                                            <div class="col-md-5 col-sm-5 col-xs-12">
                                                <input type="number" id="simpanan_koperasi" name="sumbangan_olahraga"
                                                    class="form-control">
                                            </div>
                                            </br>
                                            </br>
                                            ...
                                            <div class="col-md-5 col-sm-5 col-xs-12">
                                                <input type="number" id="porpasos" name="rumah_dinas"
                                                    class="form-control">
                                            </div>
                                            </br>
                                            </br>
                                            <label class="control-label col-md-4 col-sm-4 col-xs-12">Potongan Bank
                                                BTN</label>
                                            <div class="col-md-5 col-sm-5 col-xs-12">
                                                <input type="number" id="porpasos" name="potongan_bank2"
                                                    class="form-control">
                                            </div>
                                            </br>
                                            </br>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-info btn-xs success" data-toggle="modal"
                                        ...
                                        Lihat</button> <a href="/Cetak_Pdf_Gaji/{{ $p->kode }}" type="button"
                                    ...
                                    <button type="button" class="btn btn-warning btn-xs" data-toggle="modal"
                                        ...
                                        Edit</button>
                                    <a href="/delete/gaji/{{ $p->kode }}" class="btn btn-info btn-xs btn-danger"> <i
                                                ...
                                                <form class="form-horizontal form-label-left" action="#" method="POST"
                                                    ...
                                                    <div class="col-md-2 col-sm-2 col-xs-12">
                                                        <input type="text" id="nama" name="nama" class="form-control"
                                                            readonly value="{{ $p->nama_rekening }}">
                                                    </div>
                                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                                        <input type="text" id="nama" name="nama" class="form-control"
                                                            readonly value="{{ $p->rekening_gaji }}">
                                                    </div>
                                                    </br>
                                                    </br>
                                                    <label class="control-label col-md-4 col-sm-4 col-xs-12">No Induk
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <input type="text" id="blok" name="blok" class="form-control"
                                                            readonly
                                                            value="Rp. {{ number_format($p->gaji_pokok,2,".",",") }}">
                                                    </div>
                                                    </br>
                                                    </br>
                                                    <label class="control-label col-md-4 col-sm-4 col-xs-12">Potongan
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <input type="number" id="potongan_bank" name="potongan_dw"
                                                            readonly class="form-control" value="{{ $p->potongan_dw }}">
                                                    </div>
                                                    </br>
                                                    </br>
                                                    <label class="control-label col-md-4 col-sm-4 col-xs-12">Potongan
                                                    ...
                                                    <label class="control-label col-md-4 col-sm-4 col-xs-12">Dana
                                                        Sosial</label>
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <input type="number" id="arisan_dw" name="dana_sosial" readonly
                                                    ...
                                                    <label class="control-label col-md-4 col-sm-4 col-xs-12">Sumbangan
                                                        Olahraga</label>
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <input type="number" id="simpanan_koperasi"
                                                            name="sumbangan_olahraga" readonly class="form-control"
                                                    ...
                                                    <label class="control-label col-md-4 col-sm-4 col-xs-12">Rumah
                                                        Dinas</label>
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <input type="number" id="porpasos" name="rumah_dinas" readonly
                                                            class="form-control" value="{{$p->rumah_dinas}}">
                                                    </div>
                                                    </br>
                                                    </br>
                                                    <label class="control-label col-md-4 col-sm-4 col-xs-12">Potongan
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <input type="number" id="porpasos" name="pmi" readonly
                                                            class="form-control" value="{{$p->pmi}}">
                                                    </div>
                                                    </br>
                                                    </br>
                                                    <label
                                                        class="control-label col-md-4 col-sm-4 col-xs-12">Harkop</label>
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <input type="number" id="porpasos" name="harkop" readonly
                                                            class="form-control" value="{{$p->harkop}}">
                                                    </div>
                                                    </br>
                                                    </br>
                                                    <label
                                                        class="control-label col-md-4 col-sm-4 col-xs-12">Administrasi
                                                        Bank</label>
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <input type="number" id="porpasos" name="adm_bank" readonly
                                                            class="form-control" value="{{$p->adm_bank}}">
                                                    </div>
                                                    </br>
                                                    </br>
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <input type="text" id="kejahatan" name="kejahatan"
                                                            ...
                                                            value="Rp. {{ number_format($p->potongan_dw + $p->potongan_bank + $p->potongan_koperasi + $p->dana_sosial + $p->sumbangan_olahraga + $p->rumah_dinas + $p->potongan_bank2 + $p->pmi + $p->harkop + $p->adm_bank,2,".",",") }}">
                                                    </div>
                                                    </br>
                                                    </br>
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <input type="text" id="kejahatan" name="kejahatan"
                                                            class="form-control" readonly
                                                            value="Rp. {{ number_format($p->gaji_pokok - ($p->potongan_dw + $p->potongan_bank + $p->potongan_koperasi + $p->dana_sosial + $p->sumbangan_olahraga + $p->rumah_dinas + $p->potongan_bank2 + $p->pmi + $p->harkop + $p->adm_bank),2,".",",") }}">
                                                    </div>
                                                    </br>
                                                    </br>
                                                </form>
                                ...
                                <div class="modal fade bs-example-modal-lg-s{{ $p->kode }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal form-label-left"
                                                    action="{{route('post.update.gaji')}}" method="POST"
                                                    enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                    <label class="control-label col-md-4 col-sm-4 col-xs-12">Rekening
                                                        Bank</label>
                                                    ...
                                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                                        <input type="number" id="rekening" name="rekening"
                                                            class="form-control" value="{{ $p->rekening_gaji }}">
                                                    </div>
                                                    </br>
                                                    </br>
                                                    <label class="control-label col-md-4 col-sm-4 col-xs-12">No Induk
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <input type="number" id="gaji_pokok" name="gaji_pokok"
                                                            class="form-control" value="{{ $p->gaji_pokok}}">
                                                    </div>
                                                    </br>
                                                    </br>
                                                    <label class="control-label col-md-4 col-sm-4 col-xs-12">Potongan
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <input type="number" id="potongan_dw" name="potongan_koperasi"
                                                            class="form-control" value="{{ $p->potongan_koperasi}}">
                                                    </div>
                                                    </br>
                                                    </br>
                                                    <label class="control-label col-md-4 col-sm-4 col-xs-12">Dana
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <input type="number" id="porpasos" name="potongan_bank2"
                                                            class="form-control" value="{{$p->potongan_bank2}}">
                                                    </div>
                                                    </br>
                                                    </br>
                                                    <label class="control-label col-md-4 col-sm-4 col-xs-12">Palang
                                                        Merah Indonesia</label>
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <input type="number" id="porpasos" name="pmi"
                                                            class="form-control" value="{{$p->pmi}}">
                                                    </div>
                                                    </br>
                                                    </br>
                                                    <label
                                                        class="control-label col-md-4 col-sm-4 col-xs-12">Harkop</label>
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <input type="number" id="porpasos" name="harkop"
                                                            class="form-control" value="{{$p->harkop}}">
                                                    </div>
                                                    </br>
                                                    </br>
                                                    <label
                                                        ...
                                                        Bank</label>
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        <input type="number" id="porpasos" name="adm_bank"
                                                            class="form-control" value="{{$p->adm_bank}}">
                                                    </div>
                                                    </br>
                                                    </br>
