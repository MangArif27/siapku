<div class="content mt-2">
    <div class="row text-center">
        <div class="col-4 pe-2">
            <a href="/Apk/Visi-Misi" class="card card-style py-4 mx-0 mb-3">
                <i class="fa fa-handshake color-dark-dark fa-3x mb-2 pb-2"></i>
                <h6 class="mb-0">Visi Misi</h6>
                <span class="font-10">Tap to View</span>
            </a>
        </div>
        <div class="col-4 pe-2">
            <a href="/Apk/Struktur-Organisasi" class="card card-style py-3 mx-0 mb-3">
                <i class="fa fa-cog color-brown-light fa-3x mb-1 pb-2"></i>
                <h6 class="mb-0">Struktur Organisasi</h6>
                <span class="font-10">Tap to View</span>
            </a>
        </div>
        <div class="col-4 ps-2">
            <a href="/Apk/Informasi" class="card card-style py-3 mx-0 mb-3">
                <i class="fa fa-info-circle color-gray-dark fa-3x mb-1 pb-2"></i>
                <h6 class="mb-0">Layanan</br>Informasi</h6>
                <span class="font-10">Tap to View</span>
            </a>
        </div>
